...
def analysis():
    """
    Get mean maximum angle, median angle, and std for the pelvis and the thorax while extension of the torso.
    """
    # Getting al the repeats for the exercise 008
    ...
    title = rf"{PATHS.RES}\rom_008.csv"
